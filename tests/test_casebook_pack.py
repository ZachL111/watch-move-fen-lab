"""Regression checks for the watch-move-fen-lab casebook."""
...
from casebook.harness import assert_expected, watch_move_fen_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_move_fen_lab_summary(), assert_expected())
